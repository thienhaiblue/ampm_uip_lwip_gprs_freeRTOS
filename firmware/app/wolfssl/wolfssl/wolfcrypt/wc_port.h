...
/* filesystem abstraction layer, used by ssl.c */
    ...
    #define XBADFILE   NULL
#elif defined(AMPM_FF)
    #include "ampm_ff/ampm_ff_port.h" 
    /* stdio, default case */
    #define XFILE      AMPM_FIL*
    #define XFOPEN     ampm_fopen_win32
    #define XFSEEK     ampm_fseek_win32
    #define XFTELL     ampm_ftell_win32
    #define XREWIND(F)    ampm_fseek_win32(F,0,AMPM_SEEK_END)
    #define XFREAD     ampm_fread_win32
    #define XFWRITE    ampm_fwrite_win32
    #define XFCLOSE    ampm_fclose_win32
    #define XSEEK_END  AMPM_SEEK_END
    #define XBADFILE   NULL
#else
    /* stdio, default case */
    #define XFILE      FILE*
